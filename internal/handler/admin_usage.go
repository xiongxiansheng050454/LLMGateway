...
func (a *app) usageData(r *http.Request) (any, bool, int, string) {
...
func (a *app) listUsageLogs(r *http.Request) (any, bool, int, string) {
	query := r.URL.Query()
...
func (a *app) statsOverview(r *http.Request) (any, bool, int, string) {
	query := r.URL.Query()
...
func (a *app) statsDaily(r *http.Request) (any, bool, int, string) {
	query := r.URL.Query()
	page, pageSize := ParsePagination(r)
...
func (a *app) statsChannels(r *http.Request) (any, bool, int, string) {
	query := r.URL.Query()
