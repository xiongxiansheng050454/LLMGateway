...
// writeServiceError maps service errors to OpenAI-compatible HTTP responses.
func writeServiceError(w http.ResponseWriter, err error) {
	...
	case errors.Is(err, service.ErrStreamingUnsupported):
	...
	case errors.Is(err, service.ErrNoChannel):
