...
func (a *app) userData(r *http.Request) (any, bool, int, string) {
...
func (a *app) userRoutes(r *http.Request, parts []string) (any, bool, int, string) {
	if len(parts) == 2 {
		switch r.Method {
		case http.MethodGet:
...
func (a *app) listUsers(r *http.Request) (any, bool, int, string) {
	page, pageSize := ParsePagination(r)
	return a.result(a.store.ListUsers(page, pageSize))
}

func (a *app) createUser(r *http.Request) (any, bool, int, string) {
...
func (a *app) updateUser(r *http.Request, id int) (any, bool, int, string) {
	var req domain.UserInput
	if err := readJSON(r, &req); err != nil {
		return nil, true, http.StatusBadRequest, "invalid json"
	}
...
func (a *app) updateUserStatus(r *http.Request, id int) (any, bool, int, string) {
...
func (a *app) rechargeUser(r *http.Request, id int) (any, bool, int, string) {
...
func (a *app) listBalanceTransactions(r *http.Request, id int) (any, bool, int, string) {
	page, pageSize := ParsePagination(r)
