...
func testStore(t *testing.T) *Store {
	...
	if _, err := pool.Exec(ctx, "TRUNCATE quota_reservation_items, quota_reservations, quota_buckets, quota_policies, users, channels, rate_limit_rules RESTART IDENTITY CASCADE"); err != nil {
